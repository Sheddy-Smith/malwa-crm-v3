                    ...
                    <tbody>
                        {leads.length > 0 ? leads.map(lead => (
                            <tr key={lead.id} className="border-b dark:border-gray-700 even:bg-gray-50 dark:even:bg-gray-800/50">
                                <td className="px-3 py-1.5 font-medium dark:text-dark-text">{lead.name}</td>
                                <td className="px-3 py-1.5">{lead.company || '-'}</td>
                                <td className="px-3 py-1.5">{lead.phone}</td>
                                <td className="px-3 py-1.5">{lead.email || '-'}</td>
                                <td className="px-3 py-1.5 capitalize">{lead.source || '-'}</td>
