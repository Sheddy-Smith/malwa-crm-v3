          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-semibold dark:text-dark-text">
                Labour Ledger - {selectedEmployee?.name}
              </h3>
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50 dark:bg-gray-700">
                  <tr>
                    ...
                    <th className="px-3 py-2 text-left font-semibold dark:text-gray-300">Particulars</th>
                    <th className="px-3 py-2 text-left font-semibold dark:text-gray-300">Type</th>
                    <th className="px-3 py-2 text-right font-semibold dark:text-gray-300">Debit (₹)</th>
                    <th className="px-3 py-2 text-right font-semibold dark:text-gray-300">Credit (₹)</th>
                    <th className="px-3 py-2 text-right font-semibold dark:text-gray-300">Balance (₹)</th>
                    <th className="px-3 py-2 text-left font-semibold dark:text-gray-300">Payment Mode</th>
                  </tr>
                </thead>
                <tbody>
                  {entriesWithBalance.length === 0 ? (
                    ...
                    entriesWithBalance.map((entry, idx) => (
                      <tr key={idx} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                        ...
                        <td className="px-3 py-2 dark:text-dark-text capitalize">
                          {entry.payment_mode || '-'}
                        </td>
                      </tr>
                    ))
                ...
                {entriesWithBalance.length > 0 && (
                  <tfoot className="bg-gray-100 dark:bg-gray-800 font-bold">
                    <tr>
                      <td colSpan="3" className="px-3 py-2 dark:text-dark-text">Total</td>
