    ...
    const calculateBalances = async () => {
      ...
      try {
        ...
        vendors.forEach(vendor => {
          ...
          // Calculate payments from vouchers (what we paid them)
          ...
          // Net Balance = Opening Balance + Credits (purchases/bills) - Debits (returns) - Payments
          // Positive = We owe vendor, Negative = Vendor owes us
          const netBalance = openingBalance + totalCredit - totalDebit - totalPayments;
