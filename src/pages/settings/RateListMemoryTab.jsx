...
import { Trash2, Search, FileText, Package, TrendingUp, BarChart3, Download, Filter, RefreshCw, AlertCircle } from 'lucide-react';
                      ...
                      <td className="px-2 py-1">
                        <div className="flex justify-center">
                          <button
                            ...
                            className="group/btn relative p-1 rounded-lg bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-600 hover:text-white dark:hover:bg-red-600 transition-all duration-200"
                            title="Delete"
                          >
