...
class PageDataManager {
  constructor() {
    ...
    this.pageStoreMapping = {
      ...
      'accounts/PurchaseChallan': ['accounts'],
      'accounts/PurchaseInvoice': ['accounts'],
      'accounts/Sellchallan': ['accounts'],
      'accounts/Voucher': ['accounts'],
      
      // Sub-pages from customer/
      'customer/ContactsTab': ['customers'],
      'customer/CustomerDetailsTab': ['customers'],
      'customer/CustomerLedgerTab': ['customers'],
      'customer/CustomerProfilePage': ['customers'],
      'customer/JobHistoryTab': ['customers', 'jobs'],
      'customer/LeadsTab': ['customers'],
      'customer/LedgerTab': ['customers'],
      'customer/ProfileDetailsTab': ['customers'],
      'customer/SalesHistoryTab': ['customers'],
  ...
  async createUserWorkspace(userData) {
    try {
      ...
      const userWorkspacePath = `C:/malwa-crm/Data_base/Users/${userData.id}`;
      
      // Create user directory
      await window.electron.fs.ensureDir(userWorkspacePath);
      ...
      for (const page of mainPages) {
        if (accessiblePages.includes(page)) {
          ...
          await window.electron.fs.ensureDir(pageDir);
