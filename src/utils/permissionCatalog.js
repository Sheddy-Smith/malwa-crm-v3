...
export const PERMISSION_CATALOG = {
  ...
  LABOUR_VIEW: { code: 'LABOUR_VIEW', label: 'View Labour', module: 'Labour' },
  LABOUR_CREATE: { code: 'LABOUR_CREATE', label: 'Create Labour', module: 'Labour' },
  LABOUR_EDIT: { code: 'LABOUR_EDIT', label: 'Edit Labour', module: 'Labour' },
  LABOUR_DELETE: { code: 'LABOUR_DELETE', label: 'Delete Labour', module: 'Labour' },
  LABOUR_LEDGER_VIEW: { code: 'LABOUR_LEDGER_VIEW', label: 'View Labour Ledger', module: 'Labour' },
  LABOUR_LEDGER_EDIT: { code: 'LABOUR_LEDGER_EDIT', label: 'Edit Labour Ledger', module: 'Labour' },
  LABOUR_ATTENDANCE: { code: 'LABOUR_ATTENDANCE', label: 'Manage Attendance', module: 'Labour' },
  LABOUR_EXPORT: { code: 'LABOUR_EXPORT', label: 'Export Labour', module: 'Labour' },
...
export const PAGE_CATALOG = [
  ...
  { path: '/labour', label: 'Labour', module: 'Labour', requiredPermission: 'LABOUR_VIEW' },
