...
const sidebarNavItems = [
  ...
  { title: "Jobs", href: "/jobs", icon: Truck, permission: 'JOBS_VIEW', pageKey: 'jobs', children: [
      ...
      { title: "Chalan", href: "/jobs?step=chalan", subPageKey: 'chalanStep' }, 
  ...
  { title: "Labour", href: "/labour", icon: HardHat, permission: 'LABOUR_VIEW', pageKey: 'labour', children: [
      { title: "Labour Details", href: "/labour?tab=details", subPageKey: 'labourDetailsTab' },
      { title: "Labour Ledger", href: "/labour?tab=ledger", subPageKey: 'labourLedgerTab' },
  ]},
