        ...
        <table className="w-full text-sm border border-gray-200 dark:border-gray-700">
          <thead className="bg-gray-100 dark:bg-gray-800 text-left">
            <tr>
              ...
              <th className="py-1 px-2 border-b dark:border-gray-700">Challan No</th>
              <th className="py-1 px-2 border-b dark:border-gray-700">Date</th>
              <th className="py-1 px-2 border-b dark:border-gray-700 text-right">Total Amount</th>
          ...
          <tbody>
            {records.map((record) => (
              ...
              >
                ...
                <td className="py-1 px-2 text-gray-700 dark:text-gray-300">{record.partyName || record.party_name}</td>
                <td className="py-1 px-2 font-medium text-blue-600 dark:text-blue-400">
                  {record.invoice_no || 'N/A'}
                </td>
                <td className="py-1 px-2 font-medium text-green-600 dark:text-green-400">
                  {record.challan_no || 'N/A'}
                </td>
                <td className="py-1 px-2 text-gray-700 dark:text-gray-300">
                  {new Date(record.date).toLocaleDateString()}
                </td>
                <td className="py-1 px-2 text-right font-semibold text-gray-900 dark:text-white">
                  ₹{parseFloat(record.total || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </td>
                <td className="py-1 px-2">
              ...
              {(stepName === 'Estimate' || stepName === 'Invoice') ? (
                <>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <p className="text-sm"><span className="font-bold">Vehicle No:</span> {viewRecord.vehicleNo || viewRecord.vehicle_no || 'N/A'}</p>
                      <p className="text-sm"><span className="font-bold">Party Name:</span> {viewRecord.partyName || viewRecord.party_name || viewRecord.ownerName || 'N/A'}</p>
